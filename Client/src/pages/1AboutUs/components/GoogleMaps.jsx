...
let Team = () => {
  return (
    <div className="txtCenter section-title " style={{paddingTop:'70px'}}>
      ...
      <h2 className="font-h2">Reserve us a vitist</h2> 
      <p className="parag" >in Our Office</p>
      <h4 className="font-h4" style={{paddingBottom:'20px'}} > You are most welcomed to deal with you </h4>
