    ...
    <div>
      ...
      <div >
        {notify.map((e) => {
          ...
          //determine the icon
          if (e.text == "like your post.") { notifyTypeIcon = "likeNotify.png" }
          else if (e.text == "Added New Post") { notifyTypeIcon = "addPostNotify.png" }
          else if (e.text == "Added a Comment on Post") { notifyTypeIcon = "addcommentNotify.png" }
