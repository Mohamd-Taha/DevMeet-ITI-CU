        ...
        <div>
            ...
            <Grid container component="main" sx={{ height: '100vh' }} >
                <Grid item xs={false} sm={2} md={7} sx={{ backgroundImage: `url(${'/assets/PurpleImg.jpg'})`, backgroundSize: 'cover' }}>
                    <Typography variant="h2" style={{ position: 'absolute', color: 'whitesmoke', top: '30%', left: '40%', transform: 'translate(-55%, -20%)', fontWeight: '900', fontFamily: 'raleway' }}>
                        Make the most of your professinal life
                    </Typography>
                ...
                <Grid item xs={12} sm={8} md={5} component={Paper} elevation={20} square style={{ marginTop: '40px', backgroundColor: '#f0e8ff' }} >
                    <Box sx={{ my: 8, mx: 4, display: 'flex', flexDirection: 'column', alignItems: 'center', }} >
                        ...
                        <h2 style={{ color: 'purple', fontWeight: '900', fontFamily: 'raleway' }}>Login</h2>
                        <Box component="form" sx={{ mt: 2 }} >
                            ...
                            <Box textAlign='center'>
                                <Button type="submit" variant="contained" style={{ backgroundColor: 'purple', width: '60%', fontWeight: 'bold', fontSize: '13pt' }} sx={{ mt: 3, mb: 2 }} onClick={LoginServer} > Login  </Button>
                            ...
                            <Grid container>
                                ...
                                <Grid item>
                                    <Link href="/register" variant="body2" style={{ color: 'purple' }}> Don't have an account? Register  </Link>
                                </Grid>
                            </Grid>
                        </Box>
                    </Box>
